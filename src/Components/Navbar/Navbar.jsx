...
const Navbar = () => {
    return (
        <div className="text-center lg:sticky top-0 z-1 lg:flex py-4 bg-base-100 shadow-sm lg:px-24 px-3 justify-between items-center font-poppins">
            <div className="">
            ...
            <div className='flex gap-8 text-xl lg:space-y-0 space-y-2 flex-col lg:flex-row'>
